 ...
 */
/**
 *just constants inferface with static member
 */
public interface MyConstants {
    ...
    public static final String SHIPPINGADDRESS_SUBRESOURCE_NAME =  "shippingAddress";
    public static final String BILLINGADDRESS_SUBRESOURCE_NAME =  "billingAddress";
    //Security constants
    ...
    public static final String DEFAULT_USER_PREFIX1 = "user51";
