...
/**
 * custom validation for indentity
 */
@ApplicationScoped
@Default
public class CustomIdentityStore implements IdentityStore {
    /**
     * declare CustomIdentityStoreJPAHelper jpaHelper
     */
    @Inject
    protected CustomIdentityStoreJPAHelper jpaHelper;
    /**
     * declare Pbkdf2PasswordHash pbAndjPasswordHash
     */
    @Inject
    protected Pbkdf2PasswordHash pbAndjPasswordHash;
    /**
     * the method is to validate credentialvalidation
     */
    @Override
    ...
    /**
     * the method is to get security role name
     * @param roles Set<SecurityRole>
     * @return Set<String>
     */
